  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        ...
        <i><a href="{{url('receivePpbj')}}">Kasubag Pusat</a></i>
        @elseif(Auth::user() && Auth::user()->akses == 'Kasubag Cabang')
        <i><a href="{{url('receivePpbj')}}">Kasubag Cabang</a></i>
        @elseif(Auth::user() && Auth::user()->akses == 'Kasubag QA')
        <i><a href="{{url('receivePpbj')}}">Kasubag QA&QC</a></i>
        @elseif(Auth::user() && Auth::user()->akses == 'Kadiv')
        <i><a href="{{url('monitoring')}}">Kadiv</a></i>
        @else
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-orange">
            ...
            <a href="{{url('userspeople')}}" class="small-box-footer">Informasi Selengkapnya <i class="fa fa-arrow-circle-right"></i></a> 
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="box box-success">
              <div class="box-header with-border">
                <h3 class="box-title">Bagian di Divisi Umum</h3>
