<link rel="stylesheet" href="{{asset('css/select2.min.css')}}"> @include('sidebar')
    ...
    <div class="container-fluid spark-screen">
        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="box box-info">
                ...
                <br>
                <center>
                    <h4>Perubahan Hak Akses Untuk Login Website.</h4></center>
                <br>
                <div class="box-body">
                                    ...
                                    <div class="input-group text">
                                        ...
                                        <select name="hakakses" class="form-control select2">
                                            <option value="">{{$edituser->akses}}</option>
                                                ...
                                                <option value="{{$key->jabatan}}" {{ $edituser->jabatan == $key->jabatan ? 'selected' : '' }} > {{$key->jabatan}}
                                                </option>
                                                @endforeach
                                        </select>
                                        <br>
