...
<head>
  ...
  <link rel="shortcut icon" href="assets/images/divsum-sucofindo-4-170x96.png" type="image/x-icon">
...
<body>
  <section class="menu cid-qOdZMBbrpl" once="menu" id="menu1-l">
    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm bg-color transparent">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true"><li class="nav-item">
                    <a class="nav-link link text-white display-4" href="{{url('/')}}"><span class="mbri-home mbr-iconfont mbr-iconfont-btn"></span>
                        Beranda</a>
                </li></ul>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="mbr-white col-md-10">
                <h1 class="mbr-section-title align-center pb-3 mbr-fonts-style display-1">ADBT Team</h1>
                <p class="mbr-text align-center display-5 pb-3 mbr-fonts-style">Adalah suatu Tim Kerja yang bekerja sebagai Pemogram suatu Aplikasi dengan menggunakan beberapa Platfrom seperti Website, Desktop dan Mobile.<br>Tim ini bekerja menggunakan beberapa <em>Bahasa Pemograman</em> yang didukung dari Framework, Database, Network &amp; Graphic Design.
                </p>
                <div class="mbr-section-btn align-center"><a class="btn btn-md btn-white-outline display-4" href="page1.html#features16-w">Pengembang</a></div>
            </div>
        </div>
    </div>
...
<section class="header10 cid-qOq76LUAER mbr-fullscreen mbr-parallax-background" id="header10-p">
    ...
    <div class="container">
        <div class="media-container-column mbr-white col-lg-8 col-md-10 ml-auto">
            <h1 class="mbr-section-title align-right mbr-bold pb-3 mbr-fonts-style display-2">USING LARAVEL FRAMEWORK</h1>
...
<section class="mbr-section content4 cid-qOqhkUQjGL" id="content4-s">
        ...
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                <h2 class="align-center pb-3 mbr-fonts-style display-2">
                    Database Mysql<br>versi 14.14 distrib 5.6.21</h2>
                <h3 class="mbr-section-subtitle align-center mbr-light mbr-fonts-style display-5">
                    Is Database Portable, Opensource &amp; Multi-User.
                </h3>
...
<section class="header9 cid-qOqhzu07A7 mbr-fullscreen mbr-parallax-background" id="header9-u">
...
<section class="features16 cid-qOqxk8YCc8" id="features16-w">
...
<section class="mbr-section content8 cid-qOqzilQgRW" id="content8-x">
...
<section once="" class="cid-qOqwBfZsEO" id="footer6-v">
