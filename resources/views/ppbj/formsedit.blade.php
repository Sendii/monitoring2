                            ...
                            <div class="col-sm-3">
                                <div class="input-group text">
                                    ...
                                    <select name="id_unit" class="form-control select2" style="width:100%;" tabindex="-1" aria-hidden="true">
                                        ...
                                        <option {{ $ppbjedit->id_unit == $key->aa ? 'selected' : '' }} value="{{$key->aa}}"> {{$key->aa}}
                                        </option>
                                        @endforeach
                                    </select>
                                </div>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                <input type="text" id="subtotal" name="subtotal" class="form-control subtotal" placeholder="Total Semua" readonly value="">
                                                @endif
                                            </td>
                                        </tr>
                                    </tfoot>
