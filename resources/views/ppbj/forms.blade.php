                    ...
                    <div class="box box-info">
                        ...
                        <center>
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="input-group date">
                                            ...
                                            <input type="text" class="form-control pull-right" id="datepicker1" name="tglregisumum" value="{{$ppbjadd->tgl_regis_umum or ''}}" placeholder="Tgl. Registrasi" min="3" max="4" required>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="input-group date">
                                            ...
                                            <input type="text" class="form-control pull-right" id="datepicker2" name="tglpermintaanPpbj" value="{{$ppbjadd->tgl_permintaan_ppbj or ''}}" placeholder="Tgl. Permintaan" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="input-group date">
                                            ...
                                            <input type="text" class="form-control pull-right" id="datepicker3" name="tgldibutuhkanPpbj" value="{{$ppbjadd->tgl_dibutuhkan_ppbj or ''}}" placeholder="Tgl. Dibutuhkan" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <div class="input-group text">
                                        ...
                                        <select name="id_unit" class="form-control select2" style="width:100%;" tabindex="-1" aria-hidden="true" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="namapengadaan" class="form-control" placeholder="Nama Pengadaan" required>
                                </div>
                            </div>
                            <div class="form-group">
                                    ...
                                    <script>
                                        $(document).ready(function() {
                                            $('input[name="row"]').on('input', function() {
                                                ...
                                                var tag = '';
                                                for (i = 1; i <= row; i++) {
                                                    tag += '<tr><td><input type="text" name="nama[]" required class="form-control" placeholder="Nama Barang/Jasa" required></td><td><input type="number" required name="qty[]" placeholder="Jumlah Barang/Jasa" class="form-control qty qty' + i + '" required></td><td><input type="number" required name="harga[]" placeholder="Harga Satuan" id="amount"  class="form-control input-sm text-right amount harga harga' + i + '" required></td><td><input type="text" required name="total[]" placeholder="Total Harga"  class="form-control input-sm text-right amount total total' + i + '" readonly></td></tr>';
                                                }
                                                $('tbody').html(tag);
                                                subtotal();
                                            });
