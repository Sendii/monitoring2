...
<head>
    ...
    <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet"> @extends('layouts.adminlte')
...
<body>
    <div class="cotn_principal">
            ...
            <div class="cont_login">
                ...
                <div class="cont_back_info">
                    <div class="cont_img_back_grey">
                        <img src="{{asset('img/city.jpg')}}" alt="" />
                    </div>
        ...
        <br>
        <br>
      <a href="{{url('/')}}"><button class="btn_backto"><i class="fa fa-arrow-left"></i>&nbsp; Beranda</button></a>
        <!--<form action="{{url('/')}}">
