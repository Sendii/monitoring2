            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        <center>
                            <h2>Penugasan Data Ppbj</h2> </center>
                                ...
                                <div class="col-sm-3">
                                    <div class="input-group text">
                                        ...
                                        <select name="id_unit" class="form-control select2" disabled="disabled" style="width:100%;" tabindex="-1" aria-hidden="true">
                                            ...
                                            <option value="{{$key->id_unit}}" {{ $ppbjassignmentEdit->id_unit == $key->id_unit ? 'selected' : '' }} > {{$key->aa}}
                                            </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="input-group text">
                                        ...
                                        <select name="id_pegawai" class="form-control select2" style="width:100%;" tabindex="-1" aria-hidden="true" value="{{$ppbjassignmentEdit->id_pegawai}}">
                                            ...
                                            <option {{ $ppbjassignmentEdit->id_pegawai == $key->id_pegawai ? 'selected' : '' }} value="{{$key->id_pegawai}}"> {{$key->namapegawai}}
                                            </option>
                                            @endforeach
                                        </select>
                                    </div>
