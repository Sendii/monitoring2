...
class ExceptionHandler
{
    ...
    public function getContent(FlattenException $exception)
    {
        switch ($exception->getStatusCode()) {
            case 404:
                $title = 'Sorry, apa yang kamu lihat tidak dapat ditemukan.';
                break;
            default:
                $title = 'Whoops, Sepertinya ada kesalahan.';
        }
